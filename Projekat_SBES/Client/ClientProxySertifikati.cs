...
namespace Client
{
    public class ClientProxySertifikati : ChannelFactory<IBiblioteka>, IBiblioteka, IDisposable
    {
        IBiblioteka factory1;

        public ClientProxySertifikati(NetTcpBinding binding1, EndpointAddress address1) : base(binding1, address1)
        {
